...
bool AppDelegate::initInstance()
{
    ...
    do 
    {
        ...
        // The GameScene is designed as HVGA.
        ...
        // OpenGLView is initialized in GameScene/android/jni/GameScene/main.cpp
        ...
        cocos2d::CCFileUtils::setResource("GameScene.zip");
#endif
...
int AppDelegate::getGameLevel()
{
    return m_iGameLevel;
}

void AppDelegate::nextGameLevel()
{
