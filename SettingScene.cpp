...
SettingScene::SettingScene()
{
    ...
    color.g = 0;
    color.b = 0;
    CCLabelTTF * backgroundMusicLabel = CCLabelTTF::create("背景音乐", "Marker Felt", 20);
    backgroundMusicLabel->setAnchorPoint(ccp(0,0));
    backgroundMusicLabel->setColor(color);
    backgroundMusicLabel->setPosition(ccp(20,240));
    addChild(backgroundMusicLabel);
    
    
    CCLabelTTF * gameEffectLabel = CCLabelTTF::create("音效", "Marker Felt", 20);
    gameEffectLabel->setAnchorPoint(ccp(0,0));
    gameEffectLabel->setColor(color);
    gameEffectLabel->setPosition(ccp(20,170));
    ...
    backgroundMenu->setPosition(ccp(400,250));
    ...
    gameEffectMenu->setPosition(ccp(400,180));
